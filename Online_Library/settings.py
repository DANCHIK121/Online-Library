...
SECRET_KEY = 'django-insecure-!vb$7)*wue87!1jndlh*x2$d@)kvor%=uep#!up-$8r@x)^ew5'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'daniil_projects@mail.ru'
EMAIL_HOST_PASSWORD = '2IQidKfDNFndoAJQtMyM'
DEFAULT_FROM_EMAIL = 'daniil_projects@mail.ru'
